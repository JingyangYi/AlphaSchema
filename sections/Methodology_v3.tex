...
for downstream evaluation. Figure~\ref{fig:method_overview} summarizes this
closed-loop workflow and highlights the separation between semantic search and
